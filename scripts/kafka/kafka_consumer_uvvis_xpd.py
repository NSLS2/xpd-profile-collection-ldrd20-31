...
xlsx_fn = '/nsls2/data/xpd-new/legacy/processed/LDRD_chl/20260524_new_blop/inputs_qserver_kafka_v2.xlsx'
    ...
    def print_message(consumer, doctype, doc):
        ...
        if name == 'stop':
            ...
            if 'scattering' in kafka_process.stream_list:
                ...
                # kafka_process.stream_list.remove('baseline')
                # kafka_process.stream_list.remove('fluorescence_quality')
                kafka_process.stream_list = ['absorbance', 'fluorescence']
            ...
            for stream_name in kafka_process.stream_list:
                ...
                # print(f'{kafka_process.metadata_dic = }')
                ...
                ## macro_12 ~ macro_16
                    ...
                    if (type_peak is np.ndarray) and (type_prop is dict):
                        ...
                        print(f'\n******** optical_property ********\n\n'
                              f'PL_integral: {kafka_process.optical_property["PL_integral"]:0.2f}\n'
                              f'Absorbance_365: {kafka_process.optical_property["Absorbance_365"]:0.3f}\n'
                              f'Peak: {kafka_process.optical_property["Peak"]:0.2f}\n'
                              f'FWHM: {kafka_process.optical_property["FWHM"]:0.3f}\n'
                              f'PLQY: {kafka_process.optical_property["PLQY"]:0.4f}\n'
                              )
